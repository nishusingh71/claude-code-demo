...
import logoSvg from "../assets/dsecure-logo-full.svg";
import blogSvg from "@/assets/dsecure-logo-white.svg";
    ...
    <div className="min-h-dvh flex flex-col">
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <Link
            to="/"
            className="flex items-center gap-3 font-bold text-slate-800 hover:opacity-80 transition-opacity"
          >
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm">
            ...
            <div className="relative group">
              ...
              <div className="invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-300 absolute left-0 top-full mt-1 w-72 lg:w-80 card bg-white/95 backdrop-blur-lg border shadow-xl z-50">
                <NavLink
                  ...
                  className="block px-4 py-3 text-slate-700 hover:text-slate-900 hover:bg-slate-50/80 rounded-lg transition-colors"
                >
            ...
            <div className="relative group">
              ...
              >
                Solutions
                <span className="text-slate-400 group-hover:rotate-180 transition-transform">
                  ▾
                </span>
              </NavLink>
              <div className="invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all animate-slide-down absolute left-0 top-full mt-2 w-56 card">
                <NavLink
                  ...
                  className="flex items-center gap-2 px-4 py-3 text-slate-700 hover:text-slate-900 hover:bg-slate-50/80 rounded-lg transition-colors"
                >
                  <svg
          ...
          <div className="py-16">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              ...
              <div className="lg:col-span-4">
                <Link
                  to="/"
                  className="flex items-center gap-3 font-bold text-white hover:opacity-80 transition-opacity mb-6"
                >
                  ...
                  <img
                    src={
                      "https://res.cloudinary.com/dhwi5wevf/image/upload/v1759335919/gx6mcjfpcrntaqwxtavf.svg"
                    }
                    alt="D-Secure"
                    className="h-12 w-30 object-contain"
                  />
