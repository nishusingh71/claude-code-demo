          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <Reveal delayMs={100}>
              <p className="text-xl text-slate-600 mb-8 leading-relaxed">
                Ready to secure your data with industry-leading erasure solutions? 
                Our experts are here to help you find the perfect fit for your organization.
              </p>
            </Reveal>
          </div>
        </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <label htmlFor="consent" className="text-sm text-slate-600">
                        I agree to the processing of my personal data according to DSecure's{' '}
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-slate-200/60 p-6">
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-slate-700">Response within 2 hours</span>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-slate-700">Live chat available</span>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-slate-700">Expert technical support</span>
                    </div>
                  </div>
                </div>
              </Reveal>
            ...
            {supportOptions.map((option, i) => (
              <Reveal key={i} delayMs={i*100}>
                <div className="bg-white rounded-xl p-6 shadow-lg border border-slate-200/60 text-center hover:shadow-xl transition-shadow duration-300">
                  ...
                  <button className="w-full btn-secondary text-sm">Contact Now</button>
                </div>
              </Reveal>
            ))}
          </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container-app">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              With offices around the world, we're here to support you in your timezone.
            </p>
          </div>
