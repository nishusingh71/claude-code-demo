...
export default function HomePage() {
  return (
    <>
      <section className="bg-gradient-to-br from-emerald-50 via-teal-50/30 to-cyan-50 py-16 md:py-20 lg:py-24">
            ...
            <div className="relative lg:order-last">
              <Reveal delayMs={40}>
                <div className="relative">
                  {/* Main Hero Image */}
                  <div className="aspect-[16/10] lg:aspect-[4/3] bg-white rounded-2xl shadow-2xl border border-slate-200/60 overflow-hidden relative">
                    <img
      ...
      <section className="py-16 md:py-20 lg:py-24 bg-gradient-to-b from-slate-50/50 to-white">
        <div className="container-app">
          <div className="text-center mb-12 lg:mb-16">
            <Reveal>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
          ...
          <Reveal delayMs={40}>
            <div className="bg-white rounded-xl p-6 border border-slate-200">
              ...
              <div className="text-center mt-4">
                ...
                <a href="/services" className="btn-primary mr-3">View Detailed Pricing</a>
